...
vlog full_adder.v
vlog RCA.v
vlog -work work tb_RCA.v

# Loads a new design into the simulator
vsim -gui -novopt work.ripple_carry_adder_tb
...
add wave -position insertpoint sim:/ripple_carry_adder_tb/*
add wave -position insertpoint  \
sim:/ripple_carry_adder_tb/dut/Sum
